...
class BelgianInsuranceInvoicingFormatWriter(private val writer: Writer) {
    ...
    fun writeRecordContent(recordNumber: Int,
        ...
        ws.write("13",990)
        if (sender.isMedicalHouse) ws.write("14", sender.nihii) else if(icd.options?.get("careLocation").isNullOrBlank()) ws.write("14", icd.options?.get("careLocation")) else ws.write("14", 0)
